...
return [
    ...
    [ // $staticRoutes
        '/api/categories' => [
            ...
            [['_route' => 'get_categories', '_controller' => 'App\\Controller\\CategoryController::getCategories'], null, ['GET' => 0], null, false, false, null],
        ],
        '/api/products' => [
            [['_route' => 'create_product', '_controller' => 'App\\Controller\\ProductController::createProduct'], null, ['POST' => 0], null, false, false, null],
